...
describe('EventPanel — rendering', () => {
  ...
  it('does not render panel content when closed', () => {
    ...
    // panel is translated off-screen; heading still exists in DOM but is hidden via CSS
    // Verify the submit button is disabled/panel is not interactive
...
describe('EventPanel — close', () => {
  it('clicking ✕ calls onClose', () => {
    ...
    fireEvent.click(screen.getByTitle ? screen.getAllByRole('button')[0] : screen.getByText('✕'))
