    ...
    <tr className={`group ${purchased ? 'opacity-50' : ''}`}>
      ...
      <td className="print:hidden">
        <button
          ...
          className="w-7 h-7 flex items-center justify-center rounded-lg text-slate-300 dark:text-slate-600 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors text-sm opacity-0 group-hover:opacity-100"
        >✕</button>
      </td>
    </tr>
  )
