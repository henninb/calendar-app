...
EXAMPLE_EVENTS = [
    ...
    ("Super Bowl",                        "other",         "FREQ=YEARLY;BYMONTH=2;BYDAY=2SU",
     date(2027, 2, 8),    "NFL Super Bowl — the second Sunday of February", Priority.high, [7, 1], None),
    ...
    ("CAST Fishing Tournament — Sign Up", "local",         "FREQ=YEARLY;BYMONTH=6;BYMONTHDAY=1",
     date(2026, 7, 1),    "Sign up for Anoka County CAST fishing tournament after July 1", Priority.high, [14, 7], None),
    ("CAST Fishing Tournament Begins",   "local",         "FREQ=YEARLY;BYMONTH=7;BYMONTHDAY=1",
     date(2026, 7, 1),    "Anoka County CAST fishing tournament sign-up opens for Kids Fishing Event at Lake George", Priority.high, [7, 1], None),
